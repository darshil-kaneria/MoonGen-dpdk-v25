...
--- This file is the entry point for processing .mscap files
---
--- Valid files can be generated by sniffer.lua with no flags (mscap)
...
function configure(parser)
	...
	parser:option("-i --input", "Path to input file. Supports .mscap files."):args(1)
	parser:option("-s --second-input", "Path to second input file. Supports .mscap files."):args(1):target("second")
...
function master(args)
	...
	if string.match(args.input, ".*%.mscap") then
		...
		log:err("Input with unknown file extension. Can only process .mscap files.")
	end
